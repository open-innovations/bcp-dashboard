...
ui <- bslib::page_fluid(
  ...
  bslib::page_navbar(
    ...
    tabPanel(
      ...
      p("This microsite, and the code that underpins it, is open source and freely available in a GitHub repository at https://github.com/open-innovations/bcp-dashboard."),
      h3("Data sources:"),
